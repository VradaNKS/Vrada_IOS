...
export default class CTB16 extends React.Component{
    constructor(props){
        super(props)
        this.state={
                    ...
                    <View style={{
                        ...
                        <View style={infoDriver.container}>
                            <View style={{
                                ...
                                <View style={infoDriver.viewButton}>
                                    <TouchableOpacity style={infoDriver.btn} onPress={()=>{this._handle()}}>
                                        <Image
                                            style={infoDriver.ic}
                                            source={this.state.icCall}
                                        />
                                    </TouchableOpacity>
                                    <TouchableOpacity style={infoDriver.btn} onPress={()=>{this._handle()}}>
                                        <Image
                                            style={infoDriver.ic}
                                            source={this.state.icMess}
                                        />
                                    </TouchableOpacity>
                                </View>
                            </View>
